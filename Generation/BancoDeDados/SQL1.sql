...
CREATE TABLE tb_colaboradores( -- criando tabela 
id BIGINT AUTO_INCREMENT, -- atributos da tabela
nome VARCHAR(255),
idade INT(2),
salario DECIMAL(6,2),
cargo VARCHAR(255), -- varchar significa STRING, e o número é a quantidade de caracteres 
...
SELECT * FROM tb_colaboradores; -- selecionar todos os dados da tabela de colaboradores 
